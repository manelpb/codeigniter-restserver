...
abstract class REST_Controller extends CI_Controller {
    ...
    public function __construct($config = 'rest')
    {
        ...
        header("Access-Control-Allow-Headers: X-API-KEY, Origin, Authorization, Content-Length, X-Requested-With, X-Requested-With, Content-Type, Accept, Access-Control-Request-Method");
